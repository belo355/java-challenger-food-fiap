...
import com.fiap.challenger.food.application.domain.model.mapper.ClienteMapper;
...
public class RegistreClienteService {
    ...
    public ResponseEntity<HttpStatus> registre(ClienteForm clienteForm) {
        Optional<Cliente> optionalCliente = findByCPF(clienteForm.getDocument());
